  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M1.5 11.5L15 -1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  )
}
...
/**
 * The person mark, from the input family's exports (Figma 6:508, 6:3434,
 * 6:4527 all use the same 20px glyph).
 *
 * Shipped because the docs and the previews need a leading icon to show the
 * slot with, not because the library has an opinion about what goes in it.
 */
export function UserIcon({ size = 20 }: { size?: number }) {
  return (
    ...
    >
      <path
        d="M4.16687 16.6669V15.8336C4.16687 14.2865 4.78146 12.8028 5.87542 11.7088C6.96938 10.6148 8.45311 10.0003 10.0002 10.0003M10.0002 10.0003C11.5473 10.0003 13.031 10.6148 14.125 11.7088C15.219 12.8028 15.8335 14.2865 15.8335 15.8336V16.6669M10.0002 10.0003C10.8843 10.0003 11.7321 9.64906 12.3572 9.02394C12.9824 8.39882 13.3335 7.55098 13.3335 6.66692C13.3335 5.78287 12.9824 4.93502 12.3572 4.3099C11.7321 3.68478 10.8843 3.33359 10.0002 3.33359C9.11615 3.33359 8.26831 3.68478 7.64319 4.3099C7.01806 4.93502 6.66688 5.78287 6.66688 6.66692C6.66688 7.55098 7.01806 8.39882 7.64319 9.02394C8.26831 9.64906 9.11615 10.0003 10.0002 10.0003Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
/** The tag's remove cross (Figma 6:4209, 14px, 1.25 stroke). */
export function CloseIcon({ size = 14 }: { size?: number }) {
  return (
    ...
    >
      <path
        d="M3.94231 10.0586L7.00073 7.00018L10.0591 10.0586M10.0591 3.94176L7.00015 7.00018L3.94231 3.94176"
        stroke="currentColor"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeLinejoin="round"
